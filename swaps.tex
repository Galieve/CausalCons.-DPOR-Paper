	...
	\begin{subfigure}{.11\textwidth}
		\resizebox{\textwidth}{!}{
			\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
				...
				\node[draw, rounded corners=2mm,outer sep=0] (t3) at (-3, -3) {\begin{tabular}{l} $a \gets \rd{x}$ \end{tabular}};
				
				\node[draw, rounded corners=2mm,outer sep=0] (t4) at (-3, -4.5) {\begin{tabular}{l} $b \gets \rd{x}$ \end{tabular}};
	...
	\begin{subfigure}{.11\textwidth}
		\resizebox{\textwidth}{!}{
			\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
				...
				\node[draw, rounded corners=2mm,outer sep=0] (t2) at (-3, -1.5) {\begin{tabular}{l} $\wrt{x}{2}$ \end{tabular}};
				\node[draw, rounded corners=2mm,outer sep=0] (t3) at (-3, -4.5) {\begin{tabular}{l} $a \gets \rd{x}$ \end{tabular}};
