...
%		\State \Return
		...
		\ForAll{$t \in \genericValidWrites(h,e)$} 
		\State $h'_< \gets h_< \oplus_j e \oplus \wro(t,e)$
...
%		\State $e \gets \laste(\hist_<)$
		...
		\If{$\genericProtocol(h_<, \alpha, \beta,\locals)$}
