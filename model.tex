...
\begin{definition}
An isolation level $I$ is called \textbf{causally-extensible} if for every $I$-consistent history $h$, every $(\so \cup \wro)$-maximal pending transaction $t$ in $h$, and every event $e$, there exists a causal extension of $t$ with $e$ that is $I$-consistent.
