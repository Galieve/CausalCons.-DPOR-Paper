...
\begin{theorem}
\label{theorem:causalExtensibleModels}
Causal Consistency ($\CC$), Read Atomic ($\RA$) and Read Committed ($\RC$) are causal-extensible models.
\begin{proof}
